      ...
      <div className={s.filter}>
            <ul>
              ...
              <li className={activeTab === "orderby" ? "active" : ""}
                      onClick={handleOrder}
                      style={{listStyle: "none", cursor: 'pointer'}}><div className={s.order_text}><img src={sort} className={s.order_image}/>Сортировка</div></li>
              </div>
              <div className={s.options_inline}>
              <li className={activeTab === "filter" ? "active" : ""}
                    onClick={handleFilter}
                    style={{listStyle: "none", cursor: 'pointer'}}><div className={s.filter_text}><img src={filter} className={s.filter_image}/>Фильтр</div></li>
              </div>
            </ul>
            <div>
